...
Welcome to the SDC Repository This collection contains 16 hands-on experiments designed to learn modern web and software development skills across Frontend, Backend, and Full Stack technologies.
...
- ⚛️ React.js (SPA, Routing, Services)
...
- 🌤️ **OpenWeatherMap.org** – For real-time weather data
- 📊 **Chart.js** – For data visualization (React & Django)
- 🗄️ **MySQL / Oracle DB** – For backend Java persistence
